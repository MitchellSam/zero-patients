...
export const CITIES = {
  ...
  'jakarta': { name: 'Jakarta', color: 'red', x: 0.7547, y: 0.6664, neighbors: ['bangkok', 'chennai', 'ho-chi-minh-city', 'sydney'] },
  ...
  'lima': { name: 'Lima', color: 'yellow', x: 0.2615, y: 0.75, neighbors: ['bogota', 'mexico-city', 'santiago'] },
  ...
  'santiago': { name: 'Santiago', color: 'yellow', x: 0.2615, y: 0.8848, neighbors: ['lima'] },
  ...
  'sydney': { name: 'Sydney', color: 'red', x: 0.8721, y: 0.8104, neighbors: ['jakarta', 'los-angeles', 'manila'] },
